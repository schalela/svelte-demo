...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const live = query(client, { query: LIVE }); $live = get_store_value(live);
	...
	return `<main class="svelte-odwnil">
	  <title>Svelte SSR Demo</title>
	  <content class="svelte-odwnil">
	    <h1 class="svelte-odwnil">Live Results</h1>
	    <ul class="svelte-odwnil">
	      ${(function(__value) { if(is_promise(__value)) return `
	        <li class="svelte-odwnil">Loading...</li>
	      `; return function(result) { return `
	        ${result.data.fixtures.length ? each(result.data.fixtures, (fixture) => `<li class="svelte-odwnil">
	            <team class="svelte-odwnil">
	              <team-logo class="svelte-odwnil"></team-logo>
	              <team-name class="svelte-odwnil">${escape(fixture.homeTeam)}</team-name>
	            </team>
	            <score class="svelte-odwnil">
	              <goals class="svelte-odwnil">${escape(fixture.goalsHomeTeam)} – ${escape(fixture.goalsAwayTeam)}</goals>
	              <status class="svelte-odwnil">${escape(fixture.statusShort)}</status>
	            </score>
	            <team class="svelte-odwnil">
	              <team-logo class="svelte-odwnil"></team-logo>
	              <team-name class="svelte-odwnil">${escape(fixture.awayTeam)}</team-name>
	            </team>
	          </li>`) : `<li class="svelte-odwnil">No games live</li>`}
	      `;}(__value);}($live)) }
	    </ul>
	  </content>
	</main>`;
...
const css$1 = {
	code: "main.svelte-115uwss{text-align:center;background-color:#41563d;background-image:url(\"/bg.png\");background-repeat:repeat;background-attachment:fixed;height:100%}main.svelte-115uwss,content.svelte-115uwss{font-family:\"Inter\", sans-serif;margin:0}content.svelte-115uwss{padding:48px 0}ul.svelte-115uwss{display:flex;flex-direction:column;align-items:center;padding:0;margin:0}h1.svelte-115uwss{font-size:32px;font-weight:500;color:white;margin-bottom:32px}h2.svelte-115uwss{font-size:20px;color:white;margin-bottom:48px;font-weight:500}li.svelte-115uwss{display:flex;justify-content:space-between;box-sizing:border-box;width:640px;max-width:calc(100% - 32px);font-size:16px;padding:32px;border-radius:8px;margin-bottom:16px;place-items:center;background:white;box-shadow:0 8px 16px 0 rgba(0, 0, 0, 0.3)}@media(max-width: 500px){li.svelte-115uwss{padding:24px 8px}}team.svelte-115uwss{width:35%;text-align:center}team-name.svelte-115uwss{font-size:14px;margin:0}team-logo.svelte-115uwss{display:block;margin:0 auto;width:64px;height:64px;margin-bottom:16px;background:#f2f2f2;border-radius:32px}goals.svelte-115uwss{display:block;font-weight:500;font-size:32px;line-height:64px;margin:0 0 16px}score.svelte-115uwss{width:30%;text-align:center}status.svelte-115uwss{display:block;font-size:14px;color:#999}",
	map: "{\"version\":3,\"file\":\"[slug].svelte\",\"sources\":[\"[slug].svelte\"],\"sourcesContent\":[\"<script context=\\\"module\\\">\\n  import ApolloClient, { gql } from \\\"apollo-boost\\\";\\n  import { FIXTURES } from \\\"../../data\\\";\\n\\n  let client;\\n  export async function preload(page) {\\n    const { slug } = page.params;\\n    client = new ApolloClient({\\n      uri:\\n        \\\"https://emjxn6xptvbvlhcocrhq7gwhoy.appsync-api.ap-southeast-2.amazonaws.com/graphql\\\",\\n      headers: {\\n        \\\"x-api-key\\\": \\\"da2-htijskntwzehlai3cbhmt7c24e\\\"\\n      },\\n      fetch: this.fetch\\n    });\\n\\n    return {\\n      cache: await client.query({ query: FIXTURES, variables: { date: slug } }),\\n      date: slug\\n    };\\n  }\\n</script>\\n\\n<script>\\n  import { getClient, restore, query } from \\\"svelte-apollo\\\";\\n\\n  export let cache;\\n  export let date;\\n  restore(client, FIXTURES, cache.data);\\n\\n  const fixtures = query(client, { query: FIXTURES });\\n</script>\\n\\n<style>\\n  main {\\n    text-align: center;\\n    background-color: #41563d;\\n    background-image: url(\\\"/bg.png\\\");\\n    background-repeat: repeat;\\n    background-attachment: fixed;\\n    height: 100%;\\n  }\\n  main,\\n  content {\\n    font-family: \\\"Inter\\\", sans-serif;\\n    margin: 0;\\n  }\\n\\n  content {\\n    padding: 48px 0;\\n  }\\n  ul {\\n    display: flex;\\n    flex-direction: column;\\n    align-items: center;\\n    padding: 0;\\n    margin: 0;\\n  }\\n\\n  h1 {\\n    font-size: 32px;\\n    font-weight: 500;\\n    color: white;\\n    margin-bottom: 32px;\\n  }\\n\\n  h2 {\\n    font-size: 20px;\\n    color: white;\\n    margin-bottom: 48px;\\n    font-weight: 500;\\n  }\\n  li {\\n    display: flex;\\n    justify-content: space-between;\\n    box-sizing: border-box;\\n    width: 640px;\\n    max-width: calc(100% - 32px);\\n    font-size: 16px;\\n    padding: 32px;\\n    border-radius: 8px;\\n    margin-bottom: 16px;\\n    place-items: center;\\n    background: white;\\n    box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.3);\\n  }\\n\\n  @media (max-width: 500px) {\\n    li {\\n      padding: 24px 8px;\\n    }\\n  }\\n\\n  team {\\n    width: 35%;\\n    text-align: center;\\n  }\\n\\n  team-name {\\n    font-size: 14px;\\n    margin: 0;\\n  }\\n\\n  team-logo {\\n    display: block;\\n    margin: 0 auto;\\n    width: 64px;\\n    height: 64px;\\n    margin-bottom: 16px;\\n    background: #f2f2f2;\\n    border-radius: 32px;\\n  }\\n\\n  goals {\\n    display: block;\\n    font-weight: 500;\\n    font-size: 32px;\\n    line-height: 64px;\\n    margin: 0 0 16px;\\n  }\\n\\n  score {\\n    width: 30%;\\n    text-align: center;\\n  }\\n\\n  status {\\n    display: block;\\n    font-size: 14px;\\n    color: #999;\\n  }\\n</style>\\n\\n<main>\\n  <title>Svelte SSR Demo</title>\\n  <content>\\n    <h1>Final Results</h1>\\n    <h2>{date}</h2>\\n    <ul>\\n      {#await $fixtures}\\n        <li>Loading...</li>\\n      {:then result}\\n        {#each result.data.fixtures as fixture (fixture.fixture_id)}\\n          <li>\\n            <team>\\n              <team-logo />\\n              <team-name>{fixture.homeTeam}</team-name>\\n            </team>\\n            <score>\\n              <goals>\\n                 {fixture.goalsHomeTeam || 0} – {fixture.goalsAwayTeam || 0}\\n              </goals>\\n              <status>{fixture.statusShort}</status>\\n            </score>\\n            <team>\\n              <team-logo />\\n              <team-name>{fixture.awayTeam}</team-name>\\n            </team>\\n          </li>\\n        {:else}\\n          <li>No games live</li>\\n        {/each}\\n      {:catch error}\\n        <li>Error loading games: {error}</li>\\n      {/await}\\n    </ul>\\n  </content>\\n</main>\\n\"],\"names\":[],\"mappings\":\"AAkCE,IAAI,eAAC,CAAC,AACJ,UAAU,CAAE,MAAM,CAClB,gBAAgB,CAAE,OAAO,CACzB,gBAAgB,CAAE,IAAI,SAAS,CAAC,CAChC,iBAAiB,CAAE,MAAM,CACzB,qBAAqB,CAAE,KAAK,CAC5B,MAAM,CAAE,IAAI,AACd,CAAC,AACD,mBAAI,CACJ,OAAO,eAAC,CAAC,AACP,WAAW,CAAE,OAAO,CAAC,CAAC,UAAU,CAChC,MAAM,CAAE,CAAC,AACX,CAAC,AAED,OAAO,eAAC,CAAC,AACP,OAAO,CAAE,IAAI,CAAC,CAAC,AACjB,CAAC,AACD,EAAE,eAAC,CAAC,AACF,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,AACX,CAAC,AAED,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,KAAK,CAAE,KAAK,CACZ,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,EAAE,eAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,KAAK,CACZ,aAAa,CAAE,IAAI,CACnB,WAAW,CAAE,GAAG,AAClB,CAAC,AACD,EAAE,eAAC,CAAC,AACF,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,UAAU,CAAE,UAAU,CACtB,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CAC5B,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,IAAI,CACb,aAAa,CAAE,GAAG,CAClB,aAAa,CAAE,IAAI,CACnB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,KAAK,CACjB,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,IAAI,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AAC7C,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,EAAE,eAAC,CAAC,AACF,OAAO,CAAE,IAAI,CAAC,GAAG,AACnB,CAAC,AACH,CAAC,AAED,IAAI,eAAC,CAAC,AACJ,KAAK,CAAE,GAAG,CACV,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,SAAS,eAAC,CAAC,AACT,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,CAAC,AACX,CAAC,AAED,SAAS,eAAC,CAAC,AACT,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,OAAO,CACnB,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,KAAK,eAAC,CAAC,AACL,OAAO,CAAE,KAAK,CACd,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,AAClB,CAAC,AAED,KAAK,eAAC,CAAC,AACL,KAAK,CAAE,GAAG,CACV,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,MAAM,eAAC,CAAC,AACN,OAAO,CAAE,KAAK,CACd,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,AACb,CAAC\"}"
};
...
const Slug = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const fixtures = query(client$1, { query: FIXTURES }); $fixtures = get_store_value(fixtures);
	...
	return `<main class="svelte-115uwss">
	  <title>Svelte SSR Demo</title>
	  <content class="svelte-115uwss">
	    <h1 class="svelte-115uwss">Final Results</h1>
	    <h2 class="svelte-115uwss">${escape(date)}</h2>
	    <ul class="svelte-115uwss">
	      ${(function(__value) { if(is_promise(__value)) return `
	        <li class="svelte-115uwss">Loading...</li>
	      `; return function(result) { return `
	        ${result.data.fixtures.length ? each(result.data.fixtures, (fixture) => `<li class="svelte-115uwss">
	            <team class="svelte-115uwss">
	              <team-logo class="svelte-115uwss"></team-logo>
	              <team-name class="svelte-115uwss">${escape(fixture.homeTeam)}</team-name>
	            </team>
	            <score class="svelte-115uwss">
	              <goals class="svelte-115uwss">
	                 ${escape(fixture.goalsHomeTeam || 0)} – ${escape(fixture.goalsAwayTeam || 0)}
	              </goals>
	              <status class="svelte-115uwss">${escape(fixture.statusShort)}</status>
	            </score>
	            <team class="svelte-115uwss">
	              <team-logo class="svelte-115uwss"></team-logo>
	              <team-name class="svelte-115uwss">${escape(fixture.awayTeam)}</team-name>
	            </team>
	          </li>`) : `<li class="svelte-115uwss">No games live</li>`}
	      `;}(__value);}($fixtures)) }
	    </ul>
	  </content>
	</main>`;
