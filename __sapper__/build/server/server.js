...
var require$$0 = getCjsExportFromNamespace(matchit);
...
// import this process stub to avoid errors evaluating undefined.
...
if (typeof process === "object") {
    ...
    try {
        ...
        // extra care to replace undefined in their production builds,
...
var printDocASTReducer = {
  ...
  Field: function Field(_ref3) {
    ...
    return join$1([wrap('', alias, ': ') + name + wrap('(', join$1(args, ', '), ')'), join$1(directives, ' '), selectionSet], ' ');
  },
  ...
  InterfaceTypeDefinition: addDescription(function (_ref26) {
    ...
    return join$1(['interface', name, join$1(directives, ' '), block(fields)], ' ');
  }),
  ...
  DirectiveDefinition: addDescription(function (_ref31) {
    ...
    return 'directive @' + name + (hasMultilineItems(args) ? wrap('(\n', indent(join$1(args, '\n')), '\n)') : wrap('(', join$1(args, ', '), ')')) + ' on ' + join$1(locations, ' | ');
  }),
  ...
  InterfaceTypeExtension: function InterfaceTypeExtension(_ref35) {
    ...
    return join$1(['extend interface', name, join$1(directives, ' '), block(fields)], ' ');
  },
...
var ApolloLink = (function () {
    ...
    ApolloLink.prototype.split = function (test, left, right) {
        return this.concat(split$1(test, left, right || new ApolloLink(passthrough)));
    };
...
var ApolloClient = (function () {
    function ApolloClient(options) {
        ...
        if (!hasSuggestedDevtools && undefined !== 'production') {
...
var StoreReader = (function () {
    ...
    StoreReader.prototype.executeSelectionSet = function (_a) {
        ...
        if (this.freezeResults && undefined !== 'production') {
...
var serializeFetchParameter = function (p, label) {
    ...
    try {
        ...
        var parseError = new InvariantError$2("Network request failed. " + label + " is not serializable: " + e.message);
...
function onError$1(errorHandler) {
    return new ApolloLink(function (operation, forward) {
        return new Observable(function (observer) {
            var sub;
            var retriedSub;
...
var ErrorLink = (function (_super) {
    ...
    function ErrorLink(errorHandler) {
        var _this = _super.call(this) || this;
        _this.link = onError$1(errorHandler);
        return _this;
    }
...
var Source = function Source(body, name, locationOffset) {
  ...
  !(this.locationOffset.line > 0) ? invariant$3(0, 'line in locationOffset is 1-indexed and must be positive') : void 0;
  !(this.locationOffset.column > 0) ? invariant$3(0, 'column in locationOffset is 1-indexed and must be positive') : void 0;
 ...
 */
function parse$6(source, options) {
...
function parseDocument$1(doc) {
  ...
  var parsed = parse$7(doc, { experimentalFragmentVariables: experimentalFragmentVariables });
...
var DefaultClient = (function (_super) {
    ...
    function DefaultClient(config) {
        ...
        var errorLink = errorCallback
            ? onError$1(errorCallback)
            : onError$1(function (_a) {
                var graphQLErrors = _a.graphQLErrors, networkError = _a.networkError;
                if (graphQLErrors) {
                    graphQLErrors.map(function (_a) {
                        var message = _a.message, locations = _a.locations, path = _a.path;
                        return invariant.warn("[GraphQL error]: Message: " + message + ", Location: " +
                            (locations + ", Path: " + path));
                    });
                }
                if (networkError) {
...
function observe(observable, initial) {
    if (!isObservable(observable)) {
        return readable(observable, noop$2);
    }
...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  const live = query(client, { query: LIVE }); $live = get_store_value(live);
	...
	return `<main class="svelte-1scpi0a">
	  <title>Svelte SSR Demo</title>
	  <content class="svelte-1scpi0a">
	    <h1 class="svelte-1scpi0a">Live Results</h1>
	    <ul class="svelte-1scpi0a">
	      ${(function(__value) { if(is_promise(__value)) return `
	        <li class="svelte-1scpi0a">Loading...</li>
	      `; return function(result) { return `
	        ${result.data.fixtures.sort((a, b) => a.league_id - b.league_id || a.fixture_id - b.fixture_id).length ? each(result.data.fixtures.sort((a, b) => a.league_id - b.league_id || a.fixture_id - b.fixture_id), (fixture) => `<li class="svelte-1scpi0a">
	            <team class="svelte-1scpi0a">
	              <img${(v => v == null ? "" : ` src="${escape(fixture.homeTeam.logo)}"`)(fixture.homeTeam.logo)}${(v => v == null ? "" : ` alt="${escape(fixture.homeTeam.team_name)}"`)(fixture.homeTeam.team_name)} class="svelte-1scpi0a">
	              <team-name class="svelte-1scpi0a">${escape(fixture.homeTeam.team_name)}</team-name>
	            </team>
	            <score class="svelte-1scpi0a">
	              <goals class="svelte-1scpi0a">${escape(fixture.goalsHomeTeam)} – ${escape(fixture.goalsAwayTeam)}</goals>
	              <status class="svelte-1scpi0a">${escape(fixture.statusShort)}</status>
	            </score>
	            <team class="svelte-1scpi0a">
	              <img${(v => v == null ? "" : ` src="${escape(fixture.awayTeam.logo)}"`)(fixture.awayTeam.logo)}${(v => v == null ? "" : ` alt="${escape(fixture.awayTeam.team_name)}"`)(fixture.awayTeam.team_name)} class="svelte-1scpi0a">
	              <team-name class="svelte-1scpi0a">${escape(fixture.awayTeam.team_name)}</team-name>
	            </team>
	          </li>`) : `<li class="svelte-1scpi0a">No games live</li>`}
	      `;}(__value);}($live)) }
	    </ul>
	  </content>
	</main>`;
...
/* src/routes/date/[slug].svelte generated by Svelte v3.4.2 */

const css$1 = {
	code: "main.svelte-atiy1k{text-align:center;background-color:#41563d;background-image:url(\"/bg.png\");background-repeat:repeat;background-attachment:fixed}main.svelte-atiy1k,content.svelte-atiy1k{font-family:\"Inter\", sans-serif;margin:0}content.svelte-atiy1k{padding:48px 0}ul.svelte-atiy1k{display:flex;flex-direction:column;align-items:center;padding:0;margin:0}h1.svelte-atiy1k{font-size:32px;font-weight:500;color:white;margin-bottom:32px}h2.svelte-atiy1k{font-size:20px;color:white;margin-bottom:48px;font-weight:500}li.svelte-atiy1k{display:flex;justify-content:space-between;box-sizing:border-box;width:640px;max-width:calc(100% - 32px);font-size:16px;padding:32px;border-radius:8px;margin-bottom:16px;place-items:center;background:white;box-shadow:0 8px 16px 0 rgba(0, 0, 0, 0.3)}@media(max-width: 500px){li.svelte-atiy1k{padding:24px 8px}}team.svelte-atiy1k{width:35%;text-align:center}team-name.svelte-atiy1k{font-size:14px;margin:0}img.svelte-atiy1k{display:block;margin:0 auto;width:64px;height:64px;margin-bottom:16px;background:#f2f2f2;border-radius:32px}goals.svelte-atiy1k{display:block;font-weight:500;font-size:32px;line-height:64px;margin:0 0 16px}score.svelte-atiy1k{width:30%;text-align:center}status.svelte-atiy1k{display:block;font-size:14px;color:#999}",
	map: "{\"version\":3,\"file\":\"[slug].svelte\",\"sources\":[\"[slug].svelte\"],\"sourcesContent\":[\"<script context=\\\"module\\\">\\n  import ApolloClient, { gql } from \\\"apollo-boost\\\";\\n  import { FIXTURES } from \\\"../../data\\\";\\n\\n  let client;\\n  export async function preload(page) {\\n    const { slug } = page.params;\\n    client = new ApolloClient({\\n      uri:\\n        \\\"https://emjxn6xptvbvlhcocrhq7gwhoy.appsync-api.ap-southeast-2.amazonaws.com/graphql\\\",\\n      headers: {\\n        \\\"x-api-key\\\": \\\"da2-htijskntwzehlai3cbhmt7c24e\\\"\\n      },\\n      fetch: this.fetch\\n    });\\n\\n    return {\\n      cache: await client.query({ query: FIXTURES, variables: { date: slug } }),\\n      date: slug\\n    };\\n  }\\n</script>\\n\\n<script>\\n  import { getClient, restore, query } from \\\"svelte-apollo\\\";\\n\\n  export let cache;\\n  export let date;\\n  restore(client, FIXTURES, cache.data);\\n\\n  const fixtures = query(client, { query: FIXTURES });\\n</script>\\n\\n<style>\\n  main {\\n    text-align: center;\\n    background-color: #41563d;\\n    background-image: url(\\\"/bg.png\\\");\\n    background-repeat: repeat;\\n    background-attachment: fixed;\\n  }\\n  main,\\n  content {\\n    font-family: \\\"Inter\\\", sans-serif;\\n    margin: 0;\\n  }\\n\\n  content {\\n    padding: 48px 0;\\n  }\\n  ul {\\n    display: flex;\\n    flex-direction: column;\\n    align-items: center;\\n    padding: 0;\\n    margin: 0;\\n  }\\n\\n  h1 {\\n    font-size: 32px;\\n    font-weight: 500;\\n    color: white;\\n    margin-bottom: 32px;\\n  }\\n\\n  h2 {\\n    font-size: 20px;\\n    color: white;\\n    margin-bottom: 48px;\\n    font-weight: 500;\\n  }\\n  li {\\n    display: flex;\\n    justify-content: space-between;\\n    box-sizing: border-box;\\n    width: 640px;\\n    max-width: calc(100% - 32px);\\n    font-size: 16px;\\n    padding: 32px;\\n    border-radius: 8px;\\n    margin-bottom: 16px;\\n    place-items: center;\\n    background: white;\\n    box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.3);\\n  }\\n\\n  @media (max-width: 500px) {\\n    li {\\n      padding: 24px 8px;\\n    }\\n  }\\n\\n  team {\\n    width: 35%;\\n    text-align: center;\\n  }\\n\\n  team-name {\\n    font-size: 14px;\\n    margin: 0;\\n  }\\n\\n   img {\\n    display: block;\\n    margin: 0 auto;\\n    width: 64px;\\n    height: 64px;\\n    margin-bottom: 16px;\\n    background: #f2f2f2;\\n    border-radius: 32px;\\n  }\\n\\n  goals {\\n    display: block;\\n    font-weight: 500;\\n    font-size: 32px;\\n    line-height: 64px;\\n    margin: 0 0 16px;\\n  }\\n\\n  score {\\n    width: 30%;\\n    text-align: center;\\n  }\\n\\n  status {\\n    display: block;\\n    font-size: 14px;\\n    color: #999;\\n  }\\n</style>\\n\\n<main>\\n  <title>Svelte SSR Demo</title>\\n  <content>\\n    <h1>Final Results</h1>\\n    <h2>{date}</h2>\\n    <ul>\\n      {#await $fixtures}\\n        <li>Loading...</li>\\n      {:then result}\\n        {#each result.data.fixtures.sort((a, b) => a.league_id - b.league_id || a.fixture_id - b.fixture_id) as fixture (fixture.fixture_id)}\\n          <li>\\n            <team>\\n              <img src={fixture.homeTeam.logo} alt={fixture.homeTeam.team_name} />\\n              <team-name>{fixture.homeTeam.team_name}</team-name>\\n            </team>\\n            <score>\\n              <goals>{fixture.goalsHomeTeam || 0} – {fixture.goalsAwayTeam || 0}</goals>\\n              <status>{fixture.statusShort}</status>\\n            </score>\\n            <team>\\n              <img src={fixture.awayTeam.logo} alt={fixture.awayTeam.team_name} />\\n              <team-name>{fixture.awayTeam.team_name}</team-name>\\n            </team>\\n          </li>\\n        {:else}\\n          <li>No games live</li>\\n        {/each}\\n      {:catch error}\\n        <li>Error loading games: {error}</li>\\n      {/await}\\n    </ul>\\n  </content>\\n</main>\\n\"],\"names\":[],\"mappings\":\"AAkCE,IAAI,cAAC,CAAC,AACJ,UAAU,CAAE,MAAM,CAClB,gBAAgB,CAAE,OAAO,CACzB,gBAAgB,CAAE,IAAI,SAAS,CAAC,CAChC,iBAAiB,CAAE,MAAM,CACzB,qBAAqB,CAAE,KAAK,AAC9B,CAAC,AACD,kBAAI,CACJ,OAAO,cAAC,CAAC,AACP,WAAW,CAAE,OAAO,CAAC,CAAC,UAAU,CAChC,MAAM,CAAE,CAAC,AACX,CAAC,AAED,OAAO,cAAC,CAAC,AACP,OAAO,CAAE,IAAI,CAAC,CAAC,AACjB,CAAC,AACD,EAAE,cAAC,CAAC,AACF,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,CAAC,AACX,CAAC,AAED,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,GAAG,CAChB,KAAK,CAAE,KAAK,CACZ,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,EAAE,cAAC,CAAC,AACF,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,KAAK,CACZ,aAAa,CAAE,IAAI,CACnB,WAAW,CAAE,GAAG,AAClB,CAAC,AACD,EAAE,cAAC,CAAC,AACF,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,UAAU,CAAE,UAAU,CACtB,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,CAAC,CAC5B,SAAS,CAAE,IAAI,CACf,OAAO,CAAE,IAAI,CACb,aAAa,CAAE,GAAG,CAClB,aAAa,CAAE,IAAI,CACnB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,KAAK,CACjB,UAAU,CAAE,CAAC,CAAC,GAAG,CAAC,IAAI,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,AAC7C,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACzB,EAAE,cAAC,CAAC,AACF,OAAO,CAAE,IAAI,CAAC,GAAG,AACnB,CAAC,AACH,CAAC,AAED,IAAI,cAAC,CAAC,AACJ,KAAK,CAAE,GAAG,CACV,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,SAAS,cAAC,CAAC,AACT,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,CAAC,AACX,CAAC,AAEA,GAAG,cAAC,CAAC,AACJ,OAAO,CAAE,KAAK,CACd,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,aAAa,CAAE,IAAI,CACnB,UAAU,CAAE,OAAO,CACnB,aAAa,CAAE,IAAI,AACrB,CAAC,AAED,KAAK,cAAC,CAAC,AACL,OAAO,CAAE,KAAK,CACd,WAAW,CAAE,GAAG,CAChB,SAAS,CAAE,IAAI,CACf,WAAW,CAAE,IAAI,CACjB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,AAClB,CAAC,AAED,KAAK,cAAC,CAAC,AACL,KAAK,CAAE,GAAG,CACV,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,MAAM,cAAC,CAAC,AACN,OAAO,CAAE,KAAK,CACd,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,AACb,CAAC\"}"
};
...
async function preload$1(page) {
  ...
  return {
    cache: await client$1.query({ query: FIXTURES, variables: { date: slug } }),
    date: slug
  };
}
...
const Slug = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	let { cache, date } = $$props;
  restore(client$1, FIXTURES, cache.data);

  const fixtures = query(client$1, { query: FIXTURES }); $fixtures = get_store_value(fixtures);
	...
	$fixtures = get_store_value(fixtures);

	return `<main class="svelte-atiy1k">
	  <title>Svelte SSR Demo</title>
	  <content class="svelte-atiy1k">
	    <h1 class="svelte-atiy1k">Final Results</h1>
	    <h2 class="svelte-atiy1k">${escape(date)}</h2>
	    <ul class="svelte-atiy1k">
	      ${(function(__value) { if(is_promise(__value)) return `
	        <li class="svelte-atiy1k">Loading...</li>
	      `; return function(result) { return `
	        ${result.data.fixtures.sort((a, b) => a.league_id - b.league_id || a.fixture_id - b.fixture_id).length ? each(result.data.fixtures.sort((a, b) => a.league_id - b.league_id || a.fixture_id - b.fixture_id), (fixture) => `<li class="svelte-atiy1k">
	            <team class="svelte-atiy1k">
	              <img${(v => v == null ? "" : ` src="${escape(fixture.homeTeam.logo)}"`)(fixture.homeTeam.logo)}${(v => v == null ? "" : ` alt="${escape(fixture.homeTeam.team_name)}"`)(fixture.homeTeam.team_name)} class="svelte-atiy1k">
	              <team-name class="svelte-atiy1k">${escape(fixture.homeTeam.team_name)}</team-name>
	            </team>
	            <score class="svelte-atiy1k">
	              <goals class="svelte-atiy1k">${escape(fixture.goalsHomeTeam || 0)} – ${escape(fixture.goalsAwayTeam || 0)}</goals>
	              <status class="svelte-atiy1k">${escape(fixture.statusShort)}</status>
	            </score>
	            <team class="svelte-atiy1k">
	              <img${(v => v == null ? "" : ` src="${escape(fixture.awayTeam.logo)}"`)(fixture.awayTeam.logo)}${(v => v == null ? "" : ` alt="${escape(fixture.awayTeam.team_name)}"`)(fixture.awayTeam.team_name)} class="svelte-atiy1k">
	              <team-name class="svelte-atiy1k">${escape(fixture.awayTeam.team_name)}</team-name>
	            </team>
	          </li>`) : `<li class="svelte-atiy1k">No games live</li>`}
	      `;}(__value);}($fixtures)) }
	    </ul>
	  </content>
	</main>`;
...
const manifest = {
	...
	pages: [
...

		{
			...
			parts: [
				null,
				{ name: "date_$slug", file: "date/[slug].svelte", component: Slug, preload: preload$1, params: match => ({ slug: d$1(match[1]) }) }
			]
		}
	],
...
function middleware(opts
 ...
 = {}) {
	...
	return compose_handlers(ignore, [
		...
		get_page_handler(manifest, session || noop$3)
	].filter(Boolean));
}
